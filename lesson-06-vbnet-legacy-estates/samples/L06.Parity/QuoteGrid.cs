...
public static class QuoteGrid
{
    ...
    public static readonly decimal[] SumsInsured =
        [205_000m, 287_500m, 312_500m, 450_000m,
         487_500m, 550_000m, 612_500m, 800_000m];
    ...
    public static readonly int[] LicenceMonths = [6, 17, 18, 30, 42, 60, 90];
    public static readonly int[] Claims = [0, 1, 2, 3];
    public static readonly bool[] Commercial = [false, true];
    public static readonly int[] EngineCc = [3_000, 3_001];
    ...
    public static IEnumerable<QuoteRequest> All() =>
        ...
        from cc in EngineCc
        select new QuoteRequest(code, sum, dob, start, months, claims, commercial, cc);
}
#endregion
