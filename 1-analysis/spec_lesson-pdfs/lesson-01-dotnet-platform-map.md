...
16 pages at the 2026-09-16 build.
...
| 4 | Three languages, one runtime | story · code 4.1 (C# positional record) · compare 4.2 (C# ↔ VB program) · compare 4.3 (C# ↔ VB: compare and copy vs compare only) · chart 4.4 heatmap (C# 14 / VB / Java 21 / Kotlin 2 feature rubric, cell 34) |
...
| 6 | Your transfer map and learning path | story · chart 6.1 progress (transfer per lesson) · mermaid 6.2 flowchart TB with `direction LR` subgraphs (phases) · chart 6.3 donut (hours by phase) · table 6.4 (#, Lesson, Phase, Hours + total) · 6.5 threecol (carry over / learn / unlearn) |
...
- Chart 4.4 heatmap is a rubric (yes / some / —), stated as such in its caption; its note cites What's new in
  Visual Basic and The history of C# for the version dates.
